 ...
 * @author hp
 */
public class SignUpPageSQL extends javax.swing.JFrame {

    /**
     * Creates new form SignUpPageSQL
     */
    public SignUpPageSQL() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            PreparedStatement p=c.prepareStatement("insert into jaani values(?,?,?,?,?)");
        ...
        {
            Logger.getLogger(SignUpPageSQL.class.getName()).log(Level.SEVERE, null, ex);
        }
        LoginPageSQL h=new LoginPageSQL();
        h.setVisible(true);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpPageSQL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignUpPageSQL().setVisible(true);
            }
        });
    }
