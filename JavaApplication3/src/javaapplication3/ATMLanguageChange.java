 ...
 * @author hp
 */
public class ATMLanguageChange extends javax.swing.JFrame {

    /**
     * Creates new form ATMLanguageChange
     */
    String g,s;
    public ATMLanguageChange(String h,String k) {
        initComponents();
        s=k;
        g=h;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ATM25Number a=new ATM25Number(g,s);
        a.setVisible(true);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ATMLanguageChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
