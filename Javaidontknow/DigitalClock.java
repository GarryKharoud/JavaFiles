...
public class DigitalClock extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        z.showOpenDialog(jLabel2);
        File g =z.getSelectedFile();
        try 
        {
            BufferedImage b = ImageIO.read(new File(g.getPath())); 
            jLabel2.setIcon(new ImageIcon(b.getScaledInstance(jLabel2.getHeight(),jLabel2.getWidth(),  WIDTH)));
        }
